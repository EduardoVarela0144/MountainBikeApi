...
exports.create = (req, res) => {
    ...
    const rol = {
        ...
        userCrear: req.body.userCrear,
        userActualizar: req.body.userActualizar,
        userBorrar: req.body.userBorrar,
        imageCrear: req.body.imageCrear,
        imageActualizar: req.body.imageActualizar,
        imageBorrar: req.body.imageBorrar,
        rutasCrear: req.body.rutasCrear,
        rutasActualizar: req.body.rutasActualizar,
        rutasBorrar: req.body.rutasBorrar,
        comCrear: req.body.comCrear,
        comActualizar: req.body.comActualizar,
        comBorrar: req.body.comBorrar
    };
